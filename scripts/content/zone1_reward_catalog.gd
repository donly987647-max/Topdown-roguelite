...
func offers() -> Array[RewardOffer]:
	return [
		...
		_offer(&"shield_emitter", &"active", &"rare", _module_payload("Shield Emitter", "Immediately grants 25 temporary shield.", ["active", "survival", "shield"], [[0, 0], [1, 0]], {"left":{"type":"power_in","cell":[0, 0],"direction":"left"}}, {"power_draw":7.0,"requires_power":true,"cooldown":20.0,"charges":0,"effect_ids":["shield_pulse"],"activation_payload":{"effect":"shield_pulse","amount":25.0}}), 0.38),
		_offer(&"vent_purge", &"active", &"rare", _module_payload("Vent Purge", "Immediately removes 55 weapon heat without clearing an existing overheat lock.", ["active", "heat", "cooling"], [[0, 0], [0, 1]], {"right":{"type":"power_in","cell":[0, 0],"direction":"right"}}, {"power_draw":6.0,"requires_power":true,"cooldown":14.0,"charges":0,"effect_ids":["vent_purge"],"activation_payload":{"effect":"vent_purge","heat_removed":55.0}}), 0.40),
