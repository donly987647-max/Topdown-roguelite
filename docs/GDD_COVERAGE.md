...
| 12 | 재장전 시스템 | **PARTIAL** | 기본 재장전 구현, 완벽 재장전/취소 규칙 미완 |
| 13 | 과열 시스템 | **NOT STARTED** | GDD 기준 구현 필요 |
| 14 | 무기 시스템 | **NOT STARTED** | GDD 기준 구현 필요 |
| 15 | 무기 프레임 | **NOT STARTED** | GDD 기준 구현 필요 |
| 16 | 총열 부품 | **NOT STARTED** | GDD 기준 구현 필요 |
| 17 | 탄창 부품 | **NOT STARTED** | GDD 기준 구현 필요 |
| 18 | 코어 부품 | **NOT STARTED** | GDD 기준 구현 필요 |
| 19 | 상태 이상 | **NOT STARTED** | GDD 기준 구현 필요 |
| 20 | 장비 격자 시스템 | **NOT STARTED** | GDD 기준 구현 필요 |
...
| 63 | 기술 구조 | **PARTIAL** | 컴포넌트 일부 존재, 데이터 중심/효과 시스템 미구현 |
